...
@fileindex_cache_five_minutes.cache_on_arguments()
def create_fileindex_radolan_grid(time_resolution: TimeResolution) -> pd.DataFrame:
    """
    ...
    Args:
        time_resolution: time resolution enumeration for the requested RADOLAN product
